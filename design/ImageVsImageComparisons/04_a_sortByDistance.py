...
output_csv = "E:/EldenTex/design/ImageVsImageComparisons/sorted_mean_distance_a.csv"
...
def process_and_sort_csv(input_file, output_file):
    ...
    with open(output_file, mode='w', newline='') as outfile:
        ...
        for row in data:
            ...
            filtered_row = [entry.replace("_l.png", "") for entry in row[1:] if entry.endswith("_a_l.png")]
